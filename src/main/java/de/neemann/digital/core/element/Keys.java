...
public final class Keys {
    ...
    /**
     * The component pin label font size
     */
    public static final Key<Integer> SETTINGS_COMPONENT_FONT_SIZE =
            new Key.KeyInteger("componentFontSize", 14)
                    .setComboBoxValues(8, 10, 12, 14, 16, 18, 20, 24, 28, 32)
                    .setMin(6)
                    .setMax(48)
                    .setRequiresRepaint();
