...
public class LineBreaker {
    ...
    public String breakLines(String text) {
        ...
        if (toHTML) {
            ...
            // Use ToolTip foreground color so HTML text is visible in dark themes
            java.awt.Color fg = javax.swing.UIManager.getColor("ToolTip.foreground");
            if (fg == null) fg = java.awt.Color.BLACK;
            String hex = String.format("#%02x%02x%02x", fg.getRed(), fg.getGreen(), fg.getBlue());
            ret = "<html><span style='color:" + hex + "'>" + ret + "</span></html>";
        }
