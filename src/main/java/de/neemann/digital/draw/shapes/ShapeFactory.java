                            ...
                            case CUSTOM:
                                ...
                                if (!customShapeDescription.isEmpty())
                                    return new CustomShape(customShapeDescription, elementAttributes.getLabel(),
                                            ...
                                            pt.getOutputDescriptions(elementAttributes));
                            default:
                                Color bgColor = customDescr.getAttributes().get(Keys.BACKGROUND_COLOR);
                                // Auto-assign vibrant color in dark mode for embedded circuits
                                Color autoColor = ComponentColors.getColorForEmbedded(pt.getShortName());
                                if (autoColor != null) {
                                    bgColor = autoColor;
                                }
