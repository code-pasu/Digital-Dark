...
public final class ColorScheme {
    ...
    private static final ColorScheme DEFAULT_SCHEME = new Builder()
            ...
            .set(ColorKey.FILL, Color.WHITE)
            .build();

    private static final ColorScheme DARK_SCHEME = new Builder(DEFAULT_SCHEME)
            .set(ColorKey.BACKGROUND, new Color(42, 44, 50))
            .set(ColorKey.MAIN, new Color(220, 220, 225))
            .set(ColorKey.GRID, new Color(56, 58, 64))
            .set(ColorKey.DISABLED, new Color(65, 67, 73))
            .set(ColorKey.WIRE, new Color(90, 60, 62))           // dark maroon — editing / undriven
            .set(ColorKey.WIRE_HIGH, new Color(255, 70, 85))     // vivid red-coral — HIGH signal
            .set(ColorKey.WIRE_LOW, new Color(75, 45, 48))       // deep dark maroon — LOW signal
            .set(ColorKey.WIRE_OUT, new Color(90, 60, 62))       // muted — matches idle wire; wires show state
            .set(ColorKey.WIRE_VALUE, new Color(255, 220, 50))   // bright yellow — value text
            .set(ColorKey.WIRE_Z, new Color(100, 100, 110))      // muted gray — high-Z
            .set(ColorKey.PINS, new Color(190, 190, 200))        // bright pin labels
            .set(ColorKey.HIGHLIGHT, new Color(0, 220, 255))     // cyan highlight
            .set(ColorKey.PASSED, new Color(50, 220, 80))
            .set(ColorKey.ERROR, new Color(255, 60, 60))
            .set(ColorKey.TESTCASE, new Color(40, 80, 40, 200))
            .set(ColorKey.ASYNC, new Color(80, 40, 40, 200))
            .set(ColorKey.FILL, new Color(155, 89, 182))         // fallback purple (per-component colors used instead)
            .build();
