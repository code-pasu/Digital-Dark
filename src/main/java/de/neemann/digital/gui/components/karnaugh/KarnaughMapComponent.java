...
public class KarnaughMapComponent extends JComponent {
    ...
    protected void paintComponent(Graphics graphics) {
        ...
        gr.setColor(ThemeManager.isDarkMode() ? new Color(42, 44, 50) : Color.WHITE);
        gr.fillRect(0, 0, width, height);
        gr.setColor(ThemeManager.isDarkMode() ? new Color(210, 212, 218) : Color.BLACK);
        ...
        if (kv != null) {
            ...
            // draw table
            gr.setColor(ThemeManager.isDarkMode() ? new Color(100, 100, 110) : Color.GRAY);
